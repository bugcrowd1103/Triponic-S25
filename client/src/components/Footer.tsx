    ...
    <footer className="bg-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-primary">Our Team</a></li>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">Get travel inspiration and special offers</p>
            <div className="flex">
              <input 
                type="email" 
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} TravelPal AI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
